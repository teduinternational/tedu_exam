...
using Identity.BusinessLogic.Identity.Events.PersistedGrant;
using Identity.BusinessLogic.Identity.Mappers;
...
namespace Identity.BusinessLogic.Identity.Services
{
